	...
	#include <string.h> // biblioteca responsável por cuidar das string
		...
		int registro() // função responsalvel por cadastrar os usuários no sistema 
   	{
     	...
     	strcpy(arquivo, cpf); // responsável por copiar a string
     	...
     	file = fopen(arquivo, "a"); // abre arquivo e o "a" significa atualizar 
     	fprintf(file,",");
     	fclose(file);
    	...
    	int consulta()
   	{
		...
		printf("\t2 - Consulatar nomes\n");
		printf("\t3 - Deletar nomes\n\n"); 
		printf("opção: ");// fim do menu
		
		scanf("%d" , &opcao); // armazenando a escolhado usuário 
